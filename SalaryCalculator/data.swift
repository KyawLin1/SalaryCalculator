...
struct items{
    ...
    static var dailySalary = [String]()
    static var workDay = [String]()
    static var breakBool = [String]()
    static var thisMonth = String()
}
struct GlobalData{
    static var totalWorkingHour = Double()
    static var salary = Double()
    static var actSalary = Double()
    static var signOut = Bool()
    static var indicator = Bool()
}
